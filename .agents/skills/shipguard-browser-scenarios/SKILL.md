...
# shipguard-browser-scenarios (Codex host adapter)

Generated adapter — do not hand-edit. Single source of truth: `.hermes/skills/shipguard-browser-scenarios/SKILL.md`.
