...
A task touches the project sources outside every derived zone, or behavior listed in behavior-contract.yml.

## Archetype

code-hardening — runtime default for concern area code-hardening; the father flow re-justifies or replaces this selection from sourced project evidence.
