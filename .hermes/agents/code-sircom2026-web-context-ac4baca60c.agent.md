...
code-sircom2026-web-context-ac4baca60c
...
A task touches the sircom2026-web-context-ac4baca60c zone of the source (sircom2026/__init__.py, sircom2026/api/artifacts.py, sircom2026/api/dependencies.py, …), or behavior listed in behavior-contract.yml.

## Archetype

code-hardening — runtime default for concern area code-sircom2026-web-context-ac4baca60c; the father flow re-justifies or replaces this selection from sourced project evidence.
...
- `sircom2026/__init__.py`
- `sircom2026/api/artifacts.py`
- `sircom2026/api/dependencies.py`
- `sircom2026/api/errors.py`
- `sircom2026/api/security.py`
