...
code-tests-template-contracts-27743ce500
...
A task touches the tests-template-contracts-27743ce500 zone of the source (tests/template_contracts.py, tests/test_ui_button_contract.py), or behavior listed in behavior-contract.yml.

## Archetype

code-hardening — runtime default for concern area code-tests-template-contracts-27743ce500; the father flow re-justifies or replaces this selection from sourced project evidence.
...
- `tests/template_contracts.py`
- `tests/test_ui_button_contract.py`
- `.hermes/profile.yml`
