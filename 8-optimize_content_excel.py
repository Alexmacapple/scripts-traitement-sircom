...
try:
    ...
    print(f"\n🗑️  Étape 2 : Suppression des colonnes entièrement vides...")
    ...
    for col_num, col_letter, header in reversed(columns_to_delete):
        print(f"  🗑️  Suppression colonne {col_letter}: '{header}'")
    ...
    print(f"\n🗑️  Étape 3 : Suppression des lignes inutiles...")
    ...
    for row_num, reason in reversed(rows_to_delete):
        print(f"  🗑️  Suppression ligne {row_num} ({reason})")
