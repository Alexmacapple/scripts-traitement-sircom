...
# sircom-madeinfrance — Hermes Instructions for Claude
...
Generated child skills live in `.claude/skills/*/SKILL.md`. Load the routed skills listed by `.hermes/control/task-router.yml`; they are generated from the Father Hermes canonical skills, not external engines.
