...
- `[~]` Q75/Q77 cadrent le risque gros volumes : traitements lourds en tâche de fond, progression visible et seuils configurables. Reste à fixer les seuils et le mécanisme technique de file/tâche de fond.
- `[~]` Q78 cadre l'import Excel sale : reste à définir les contrôles techniques exacts et les messages d'erreur métier.
...
- Fixer les seuils de volume par défaut pour la V1 et choisir le mécanisme technique de file/tâche de fond compatible Mac local puis VPS -> implémentation.
- Définir les contrôles techniques exacts d'analyse Excel sale et les messages d'erreur métier -> implémentation.
