...
Frontier qualité 18+ restante : tickets 30 à 32.
...
- tickets 30 à 32 : `ready-for-agent`, issus de l'évaluation qualité 16,5/20
  et découpés avec contrats préalables pour limiter la friction LLM ;
- tickets 26, 27, 28, 29A, 29B, 29C, 29D et 33 : `done` ;
