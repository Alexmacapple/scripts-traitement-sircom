...
# de traiter automatiquement le fichier "01-cellules-vide-na.xlsx",
# d'ajouter la lettre de chaque colonne suivie d'un underscore (_) au début de chaque en-tête de colonne,
# et d'enregistrer le fichier sous "02-header-lettres-colonne.xlsx"

# python3 02-header_lettres_colonne.py
...
try:
    ...
    output_filename = config_value("step_02_output")
