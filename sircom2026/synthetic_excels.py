...
CASES: tuple[SyntheticWorkbookCase, ...] = (
    SyntheticWorkbookCase(
        ...
        description="Multi-onglets importable, positions id_dossier variees, onglet vide ignore.",
    ),
    SyntheticWorkbookCase(
        name="missing_id",
    ...
    SyntheticWorkbookCase(
        ...
        expected_importable=False,
        description="Doublon de cle primaire id_dossier dans un onglet.",
    ),
    SyntheticWorkbookCase(
        name="ambiguous_id",
        filename="sircom2026-refus-id-ambigu.xlsx",
        expected_importable=False,
        description="Plusieurs colonnes candidates id_dossier dans le meme onglet.",
    ),
    SyntheticWorkbookCase(
        name="merged_cells",
        filename="sircom2026-refus-cellules-fusionnees.xlsx",
        expected_importable=False,
        description="Cellules fusionnees detectees.",
    ),
    SyntheticWorkbookCase(
        name="hidden_column",
        filename="sircom2026-refus-colonne-masquee.xlsx",
        expected_importable=False,
        description="Colonne masquee detectee.",
    ),
    SyntheticWorkbookCase(
        name="formula",
        filename="sircom2026-refus-formule.xlsx",
        expected_importable=False,
        description="Formule detectee.",
    ),
    SyntheticWorkbookCase(
